...
<div>
 <h2>ZipCode</h2>
      <p>Search by ZipCode.  Not sure what's the number? Try your best and we'll find the closest cities that sound like your search entry.</p>
      <p><a class="btn btn-default" href="CoffeeSearch">Back to Home</a></p>
      <p><input type="text" name="zip"><input type="submit" value="search"> </p>
      <input type="hidden" value="PostalCode" name="type" />
    </div>
